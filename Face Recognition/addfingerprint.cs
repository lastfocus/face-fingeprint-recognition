...
namespace Fingeprint
{
    public partial class addfingerprint : Form
    {
        ...
        public addfingerprint(string name)
        {
            InitializeComponent();
...
private void SaveFrame_Click(object sender, EventArgs e)
{
    ...
    if (!save_training_data(m_picture.Image))
        MessageBox.Show("Ошибка", "Ошибка при сохранении данных. Данные не сохранены", MessageBoxButtons.OK, MessageBoxIcon.Error);
